...
MODEL_SWITCH_RULE: Before coding/implementation work, switch to model alias `codex`. Before spec drafting/brainstorming/conversation work, switch to model alias `gpt`.
